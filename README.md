...
| `API_DEPOT_VALIDATION_PROFILE`              | Profil de validation: `strict` (défaut), `us`, `permissive`                                        |
| `API_DEPOT_VALIDATION_US_DOWNGRADED_ERRORS` | Liste CSV des codes erreur à rétrograder en warning pour le profil `us`                            |
| `API_DEPOT_PERMISSIVE_VALIDATION`           | Variable historique (dépréciée), remplacer par `API_DEPOT_VALIDATION_PROFILE`                      |
| ---                                         | ---                                                                                                |
